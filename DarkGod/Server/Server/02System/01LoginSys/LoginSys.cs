...
public class LoginSys {
    ...
    public void ReqLogin(MsgPack pack) {
        ...
        if (cacheSvc.IsAcctOnLine(data.acct)) {
            ...
            if (pd == null) {
                ...
                long milllseconds = now - pd.time;
                int addPower = (int)(milllseconds / (1000 * 60*60 * PECommon.PowerAddSpace)) * PECommon.PowerAddCount;
    ...
    public void ClearOfflineData(ServerSession session) {
        ...
        { 
            ...
            {
                PECommon.Log("Update offine time error",LogType.Error);
            }

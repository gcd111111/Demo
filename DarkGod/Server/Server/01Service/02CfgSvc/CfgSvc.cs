...
public class CfgSvc
{
    ...
    private void InitGuideCfg()
    {
        ...
        doc.Load(@"D:\unity\project\DarkGod\Client\Assets\Resources\ResCfgs\guide.xml");
    ...
    {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"D:\unity\project\DarkGod\Client\Assets\Resources\ResCfgs\strong.xml");
 ...
 private Dictionary<int, TaskRewardCfg> taskRewardDic = new Dictionary<int, TaskRewardCfg>();
    ...
    {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"D:\unity\project\DarkGod\Client\Assets\Resources\ResCfgs\taskreward.xml");
    ...
    {
        XmlDocument doc = new XmlDocument();
        doc.Load(@"D:\unity\project\DarkGod\Client\Assets\Resources\ResCfgs\map.xml");
